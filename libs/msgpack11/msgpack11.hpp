/**
 * @file msgpack11.hpp
 * @brief MessagePack adaptation for dynamo
 * @version 0.1
 * @date 2022-05-20
 * 
 * @copyright Copyright (c) 2022
 * 
 * @details MessagePack is an efficient binary serialization format. 
 *          It lets you exchange data among multiple languages like JSON. 
 *          But it's faster and smaller. Small integers are encoded into 
 *          a single byte, and typical short strings require only one 
 *          extra byte in addition to the strings themselves.
 * 
 *          The implementation of this code was taken from Mashiro Wada on GitHub (https://github.com/ar90n/msgpack11)
 */

#ifndef DEV_DYNAMO_MSGPACK11
#define DEV_DYNAMO_MSGPACK11
