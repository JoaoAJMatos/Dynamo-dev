...
//
// This class defines a basic structure for the creation of a WebServer

#ifndef DEV_DYNAMO_WEBSERVER_H
#define DEV_DYNAMO_WEBSERVER_H
...
namespace net
{
    ...
    public:
        /* CONSTRUCTOR */
        WebServer(int domain, int service, int protocol, int port, unsigned long iface, int bklg);
        ~WebServer();
